...
class ImovelFavoritoController extends GxController {

	
    public function getRepresentingFields(){
		return ImovelFavorito::representingColumn();
	}
    
	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'ImovelFavorito'),
		));
	}

	public function actionCreate() {
		$model = new ImovelFavorito;
        
		if (isset($_POST['ImovelFavorito'])) {
			$model->setAttributes($_POST['ImovelFavorito']);

			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					Yii::app()->end();
				else
					$this->redirect($this->createUrlRel('view',array('id' => $model->idimovel_favorito,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['ImovelFavorito'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idimovel_favorito,'success'=>'update')));
			}
		}
	...
	{
		$model=ImovelFavorito::model()->findByPk($id);
		if($model===null)
	...
	public function actionIndex() {
		...
		if(isset($_GET['o']) && isset($_GET['f']) ){
        	...
        	$criteria->order = 'idimovel_favorito desc';
        }
		...
		$dataProvider = new CActiveDataProvider('ImovelFavorito', array(
            'criteria'=>$criteria,
			'pagination' => array(
