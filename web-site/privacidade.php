...
<title>Loteamento Digital | Pol&iacute;tica de privacidade</title>
<?php include("header.php"); ?>
<style type="text/css"><?php echo file_get_contents('css/formularios.css');?></style>
</head>
<body>
<div id="wrapper" class="funcionalidades">
  <div id="topo">
    <?php include("topo.php"); ?>
    <div class="header-funcionalidades">
      <div class="container">
        <section class="colunas col-20 texto-header">
          <h2>Pol&iacute;tica de<br /><strong>privacidade</strong> </h2>
          <p>Inicial &raquo; Pol&iacute;tica de Privacidade</p>
        </section>
        <div class="clear"></div>
      </div>
    </div>
  ...
  <div id="conteudo">
    <div class="container politicas">
      <h2>Pol&iacute;tica Privacidade</h2>
      <p>A sua privacidade &eacute; importante para n&oacute;s. &Eacute; pol&iacute;tica do Loteamento Digital respeitar a sua privacidade em rela&ccedil;&atilde;o a qualquer informa&ccedil;&atilde;o sua que possamos coletar no site <a href=https://loteamento.digital>Loteamento Digital</a>, e outros sites que possu&iacute;mos e operamos.</p>
      ...
      <h2>Pol&iacute;tica de Cookies Loteamento Digital</h2>
      ...
      <ul>
        ...
        <li> Cookies de prefer&ecirc;ncias do site<br>
          <br>
          Para proporcionar uma &oacute;tima experi&ecirc;ncia neste site, fornecemos a funcionalidade para definir suas prefer&ecirc;ncias de como esse site &eacute; executado quando voc&ecirc; o usa. Para lembrar suas prefer&ecirc;ncias, precisamos                            definir cookies para que essas informa&ccedil;&otilde;es possam ser chamadas sempre que voc&ecirc; interagir com uma p&aacute;gina for afetada por suas prefer&ecirc;ncias.<br>
        </li>
      </ul>
      ...
      <p>O usu&aacute;rio se compromete a fazer uso adequado dos conte&uacute;dos e da informa&ccedil;&atilde;o que o Loteamento Digital oferece no site e com car&aacute;ter enunciativo, mas n&atilde;o limitativo:</p>
      <ul>
        ...
        <li>B) N&atilde;o difundir propaganda ou conte&uacute;do de natureza racista, xenof&oacute;bica, ou casas de apostas online (ex.:<a href='https://ondeapostar.pt/review/moosh-portugal/'> Moosh</a>), jogos de sorte e azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
        <li>C) N&atilde;o causar danos aos sistemas f&iacute;sicos (hardwares) e l&oacute;gicos (softwares) do Loteamento Digital, de seus fornecedores ou terceiros, para introduzir ou disseminar v&iacute;rus inform&aacute;ticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
      </ul>
      ...
      <p>Esta pol&iacute;tica &eacute; efetiva a partir de <strong>Junho</strong>/<strong>2021</strong>.</p>
    </div>
  </div>
  <div id="rodape" class="mt60"><?php include("rodape.php"); ?> </div>
  <div class="clear"></div>
</div>
