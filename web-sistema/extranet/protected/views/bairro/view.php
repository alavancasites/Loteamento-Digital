...
?><div class="row">
  <div class="col-md-12">
      <div class="card">
        ...
        <div class="formSep">
          <dl class="dl-horizontal">
            <dt><?=Util::formataTexto($model->getAttributeLabel('idcidade'));?></dt>
            <dd><?=($model->cidade !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->cidade)), array('cidade/view', 'id' => GxActiveRecord::extractPkValue($model->cidade, true)),array('class' => 'relational-link')) : null)?></dd>
          </dl>
        </div>
        <div class="formSep">
          <dl class="dl-horizontal">
              ...
              <dl class="dl-horizontal">
                  ...
                  <dd>
                    ...
                    if(Yii::app()->user->obj->group->temPermissaoAction($this->id,'update')){
                        ?>
                        <a class="btn btn-outline-primary" href="<?php echo $this->createUrlRel('update',array('id'=>$model->idbairro));?>"><i class="ion ion-md-create "></i> Editar</a>
                        <?
                    }
                    ?>          
                    <?
                    ...
                    if(Yii::app()->user->obj->group->temPermissaoAction($this->id,'delete')){
                        ?>
                        <a class="btn btn-outline-danger btn-delete" href="<?php echo $this->createUrlRel('delete',array('id'=>$model->idbairro));?>" style="margin-left:30px;"><i class=" ion ion-md-trash"></i> Excluir</a>
                        <?
                    }
                    ?>           
                  </dd>
