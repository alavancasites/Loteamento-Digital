...
?><div class="row">
  <div class="col-md-12">
      <div class="card">
        ...
        <div class="formSep">
          <dl class="dl-horizontal">
            <dt><?=Util::formataTexto($model->getAttributeLabel('idimovel'));?></dt>
            <dd><?=($model->imovel !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->imovel)), array('imovel/view', 'id' => GxActiveRecord::extractPkValue($model->imovel, true)),array('class' => 'relational-link')) : null)?></dd>
          </dl>
        </div>
        <div class="formSep">
          <dl class="dl-horizontal">
