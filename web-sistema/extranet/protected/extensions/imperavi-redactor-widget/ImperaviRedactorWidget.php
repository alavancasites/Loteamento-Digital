...
class ImperaviRedactorWidget extends CInputWidget
{
	...
	protected function registerClientScript()
	{
		...
		$this->options = array_merge(array( 
			/*'fileUpload' => Yii::app()->createAbsoluteUrl('//site/upload?type=file&model='.get_class($this->model)),
			'imageUpload' => Yii::app()->createAbsoluteUrl('//site/upload?type=image&model='.get_class($this->model)),*/
			'lang' => 'pt_br',
			'minHeight' => 500,
		),$this->options);
