...
?><div class="row-fluid">
  <div class="span12">
      <div class="w-box">
        ...
        <div class="formSep">
          <dl class="dl-horizontal">
            <dt><?=Util::formataTexto($model->getAttributeLabel('aceito'));?></dt>
            <dd><?=Util::formataTexto($model->aceito ? 'Sim' : 'Não')?></dd>
          </dl>
        </div>
        <div class="formSep">
          <dl class="dl-horizontal">
              ...
              <dl class="dl-horizontal">
                  ...
                  <dd>
                    ...
                    if(Yii::app()->user->obj->group->temPermissaoAction($this->id,'update')){
                        ?>
                        <a class="btn" href="<?php echo $this->createUrlRel('update',array('id'=>$model->idnewsletter));?>"><i class="icon-edit "></i> Editar</a>
                        <?
                    }
                    ?>          
                    <?
