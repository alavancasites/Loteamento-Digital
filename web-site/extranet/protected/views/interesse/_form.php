<div class="form">
    ...
    <div class="formSep">
        <dl class="dl-horizontal">
          <dt><?php echo $form->labelEx($model,'dia',array('class'=>'control-label')); ?>
</dt>
          <dd>
		  	<?php $this->widget('CJuiDateTimePicker',array(
								'model'=>$model, //Model object
								'attribute'=>'dia', //attribute name
								'language' => 'pt',
    ...
    <div class="formSep">
        <dl class="dl-horizontal">
          <dt><?php echo $form->labelEx($model,'hora',array('class'=>'control-label')); ?>
</dt>
          <dd>
		  	<?php echo $form->textField($model, 'hora', array('maxlength' => 100,'class' => 'input-xxlarge')); ?>                 
