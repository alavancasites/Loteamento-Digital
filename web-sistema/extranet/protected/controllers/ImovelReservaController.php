...
class ImovelReservaController extends GxController {


	public function getRepresentingFields(){
		return ImovelReserva::representingColumn();
	}

	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'ImovelReserva'),
		));
	}
	...
	public function actionCreate() {
		...
		if (isset($_POST['ImovelReserva'])) {
			...
			if ($model->save()) {
				...
				$this->redirect($this->createUrlRel('view',array('id' => $model->idimovel_reserva,'success'=>'create')));
			}
		}
		else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['ImovelReserva'])) {
			...
			if ($model->save()) {
				$this->redirect($this->createUrlRel('view',array('id' => $model->idimovel_reserva,'success'=>'update')));
			}
		}
	...
	{
		$model=ImovelReserva::model()->findByPk($id);
		if($model===null)
	...
	public function actionIndex() {
		...
		if(isset($_GET['o']) && isset($_GET['f']) ){
			...
			$criteria->order = 'idimovel_reserva desc';
		}
		...
		$dataProvider = new CActiveDataProvider('ImovelReserva', array(
			'criteria'=>$criteria,
			'pagination' => array(
