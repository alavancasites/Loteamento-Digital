        ...
        ChartJs.prototype.init = function () {
            ...
            var data = {
                ...
                datasets: [
                    ...
                    {
                        backgroundColor: "rgba(110,140,215,0.4)",
                        borderColor: "rgba(110,140,215,0.4)",
                        pointColor: "rgba(110,140,215,1)",
                        pointStrokeColor: "#fff",
            ...
            var data4 = {
                ...
                datasets: [
                    {   label: "Desktops",
                        backgroundColor: "rgba(110,140,215, 0.5)",
                        borderColor: "rgba(110,140,215, 0.75)",
                        pointBackgroundColor: "rgba(110,140,215, 1)",
