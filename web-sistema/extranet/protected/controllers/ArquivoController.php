...
class ArquivoController extends GxController {
    ...
    public function getRepresentingFields(){
		return Arquivo::representingColumn();
	}
		...
		if (isset($_POST['Arquivo'])) {
			...
			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					...
					$this->redirect($this->createUrlRel('view',array('id' => $model->idarquivo,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['Arquivo'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idarquivo,'success'=>'update')));
			}
		}
	...
	public function actionIndex() {
		...
		$dataProvider = new CActiveDataProvider('Arquivo', array(
            'criteria'=>$criteria,
			'pagination' => array(
