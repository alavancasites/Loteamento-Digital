...
class ArquivoCategoriaController extends GxController {

	
    public function getRepresentingFields(){
		return ArquivoCategoria::representingColumn();
	}
    
	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'ArquivoCategoria'),
		));
	}

	public function actionCreate() {
		$model = new ArquivoCategoria;
        
		if (isset($_POST['ArquivoCategoria'])) {
			$model->setAttributes($_POST['ArquivoCategoria']);

			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					Yii::app()->end();
				else
					$this->redirect($this->createUrlRel('view',array('id' => $model->idarquivo_categoria,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['ArquivoCategoria'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idarquivo_categoria,'success'=>'update')));
			}
		}
	...
	{
		$model=ArquivoCategoria::model()->findByPk($id);
		if($model===null)
	...
	public function actionIndex() {
		...
		if(isset($_GET['o']) && isset($_GET['f']) ){
        	...
        	$criteria->order = 'idarquivo_categoria desc';
        }
		...
		$dataProvider = new CActiveDataProvider('ArquivoCategoria', array(
            'criteria'=>$criteria,
			'pagination' => array(
