...
?><div class="row">
  <div class="col-md-12">
      <div class="card">
        ...
        <div class="formSep">
          <dl class="dl-horizontal">
            <dt><?=Util::formataTexto($model->getAttributeLabel('limite_empreendimentos'));?></dt>
            <dd><?=Util::formataTexto($model->limite_empreendimentos)?></dd>
          </dl>
        </div>
        <div class="formSep">
          <dl class="dl-horizontal">
            <dt><?=Util::formataTexto($model->getAttributeLabel('limite_imoveis'));?></dt>
            <dd><?=Util::formataTexto($model->limite_imoveis)?></dd>
          </dl>
        </div>
        <div class="formSep">
          <dl class="dl-horizontal">
            <dt><?=Util::formataTexto($model->getAttributeLabel('limite_corretores'));?></dt>
            <dd><?=Util::formataTexto($model->limite_corretores)?></dd>
          </dl>
        </div>
        <div class="formSep">
          <dl class="dl-horizontal">
            <dt><?=Util::formataTexto($model->getAttributeLabel('limite_usuarios'));?></dt>
            <dd><?=Util::formataTexto($model->limite_usuarios)?></dd>
          </dl>
        </div>
        <div class="formSep">
          <dl class="dl-horizontal">
        ...
        <div class="formSep">
          <dl class="dl-horizontal">
            <dt><?=Util::formataTexto($model->getAttributeLabel('valor_adicional_usuario'));?></dt>
            <dd><?=Util::formataTexto($model->valor_adicional_usuario)?></dd>
          </dl>
        </div>
        <div class="formSep">
          <dl class="dl-horizontal">
            <dt><?=Util::formataTexto($model->getAttributeLabel('valor_adicional_empreendimento'));?></dt>
            <dd><?=Util::formataTexto($model->valor_adicional_empreendimento)?></dd>
          </dl>
        </div>
	...
	if(Yii::app()->user->obj->group->temPermissaoAction('cliente','index')){
        ...
        <div class="formSep">
            <dl class="dl-horizontal">
                <dt><?php echo GxHtml::encode($model->getRelationLabel('clientes')); ?></dt>
                <dd>
                <?php
                if(count($model->clientes) > 0){
              ...
              <dl class="dl-horizontal">
                  ...
                  <dd>
                    ...
                    if(Yii::app()->user->obj->group->temPermissaoAction($this->id,'update')){
                        ?>
                        <a class="btn btn-outline-primary" href="<?php echo $this->createUrlRel('update',array('id'=>$model->idplano));?>"><i class="ion ion-md-create "></i> Editar</a>
                        <?
                    }
                    ?>          
                    <?
