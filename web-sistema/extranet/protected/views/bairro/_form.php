<div class="form">
    ...
    <div class="formSep">
        <dl class="dl-horizontal">
          <dt><?php echo $form->labelEx($model,'idcidade',array('class'=>'control-label')); ?>
</dt>
          <dd>
		  	<?php echo $form->dropDownList($model, 'idcidade', GxHtml::listDataEx(Cidade::model()->findAllAttributes(null, true)), array('class' => 'form-control','empty'=>'Selecione...')); ?>                 
