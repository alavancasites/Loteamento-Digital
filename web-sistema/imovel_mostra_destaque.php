<div class="col-md-3">
    <div class="imovel-destaque">
        ...
        <div class="colunas col-5 imovel_box status_<?= $imovel->status ?> pull-left">
            ...
            <div class="imoveis_conteudo">
                ...
                <div class="descricao">
                    ...
                    <span>Frente: <?= $imovel->metragem_frente ?></span>
                    <span>Lateral Esquerda: <?= $imovel->metragem_esquerda ?></span>
                    <span>Lateral Direita: <?= $imovel->metragem_direita ?></span>
                    <span>Fundos: <?= $imovel->metragem_fundo ?></span>
                                ...
                                <div class="colunas col-12 off-4 mt20">
                                    ...
                                    ?>
                                            <div class="dados_clientes">
                                                ...
                                                <div><strong>Observações:</strong> <?= Util::formataTexto($imovel->imovelReserva->observacoes) ?></div>
                                        ...
                                        ?>
                                            <div class="dados_clientes">
                                                ...
                                                <div><strong>Observações:</strong> <?= Util::formataTexto($imovel->imovelReservaSeg->observacoes) ?></div>
                                                <div class="text-center"><a href="reserva?id=<?= $imovel->idimovel_reserva ?>">EDITAR DADOS</a></div>
                                            </div>
                                        <?php
                                        }
        ...
        <div class="colunas col-14 texto-destaque">
            <?
