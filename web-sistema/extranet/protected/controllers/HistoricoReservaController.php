...
class HistoricoReservaController extends GxController {

	
    public function getRepresentingFields(){
		return HistoricoReserva::representingColumn();
	}
    
	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'HistoricoReserva'),
		));
	}

	public function actionCreate() {
		$model = new HistoricoReserva;
        
		if (isset($_POST['HistoricoReserva'])) {
			$model->setAttributes($_POST['HistoricoReserva']);

			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					Yii::app()->end();
				else
					$this->redirect($this->createUrlRel('view',array('id' => $model->idhistorico_reserva,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['HistoricoReserva'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idhistorico_reserva,'success'=>'update')));
			}
		}
	...
	{
		$model=HistoricoReserva::model()->findByPk($id);
		if($model===null)
	...
	public function actionIndex() {
		...
		if(isset($_GET['o']) && isset($_GET['f']) ){
        	...
        	$criteria->order = 'idhistorico_reserva desc';
        }
		...
		$dataProvider = new CActiveDataProvider('HistoricoReserva', array(
            'criteria'=>$criteria,
			'pagination' => array(
