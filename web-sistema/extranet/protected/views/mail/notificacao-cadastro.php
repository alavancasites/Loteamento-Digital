...
<title>Novo corretor cadastrado</title>
  ...
  <div style="width:750px; margin-left:auto; margin-right:auto;">
    <div>
      ...
      <div style="margin-top:30px">
        <h1 style="color: #555; font-size:16px; text-align:center; display:block;">Novo corretor cadastrado</h1>
        <div style="margin-top:20px; padding:20px;">
          <h2>Um novo corretor efetuou o cadastro no site.</h2>
          <h2>Acesse a &aacute;rea adminstrativa e confira as informações.</h2>
          <p style="margin-top:40px;"> Acesse o link abaixo para acessar o sistema e conferir os dados. <br>
          <br>
          <a href="<?php echo Yii::app()->sistema_url; ?>/extranet" style="background:#ff6d38; font-weight: 800; padding: 10px 20px; border-radius: 5px;color:#fff; text-decoration: none; ">Acessar</a> </p>
        </div>
      </div>
      <br />
    </div>
