...
class IndiceController extends GxController {

	
    public function getRepresentingFields(){
		return Indice::representingColumn();
	}
    
	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'Indice'),
		));
	}
	...
	public function actionCreate() {
		...
		if (isset($_POST['Indice'])) {
			$model->setAttributes($_POST['Indice']);

			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					Yii::app()->end();
				else
					$this->redirect($this->createUrlRel('view',array('id' => $model->idindice,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['Indice'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idindice,'success'=>'update')));
			}
		}
	...
	public function actionIndex() {
		...
		$dataProvider = new CActiveDataProvider('Indice', array(
            'criteria'=>$criteria,
			'pagination' => array(
