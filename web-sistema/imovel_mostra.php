<div class="col-md-3">
    ...
    <div class="imovel_box status_<?= $imovel->status ?>">
        ...
        <div class="imoveis_conteudo">
            ...
            <div class="descricao">
                <p>Área total: <?= $imovel->metragem ?> m&sup2;</p>
                <p>Frente: <?= $imovel->metragem_frente ?> m</p>
                <p>Lateral Esquerda: <?= $imovel->metragem_esquerda ?> m</p>
                <p>Lateral Direita: <?= $imovel->metragem_direita ?> m</p>
                <p>Fundos: <?= $imovel->metragem_fundo ?> m</p>
                <?php
                if ($imovel->destaque) {
