...
class BairroController extends GxController {

	
    public function getRepresentingFields(){
		return Bairro::representingColumn();
	}
    
	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'Bairro'),
		));
	}
		...
		if (isset($_POST['Bairro'])) {
			...
			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					...
					$this->redirect($this->createUrlRel('view',array('id' => $model->idbairro,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['Bairro'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idbairro,'success'=>'update')));
			}
		}
	...
	public function actionIndex() {
		...
		$dataProvider = new CActiveDataProvider('Bairro', array(
            'criteria'=>$criteria,
			'pagination' => array(
