...
class PlanoController extends GxController {

	
    public function getRepresentingFields(){
		return Plano::representingColumn();
	}
    
	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'Plano'),
		));
	}
	...
	public function actionCreate() {
		...
		if (isset($_POST['Plano'])) {
			$model->setAttributes($_POST['Plano']);

			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					Yii::app()->end();
				else
					$this->redirect($this->createUrlRel('view',array('id' => $model->idplano,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['Plano'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idplano,'success'=>'update')));
			}
		}
	...
	public function actionIndex() {
		...
		$dataProvider = new CActiveDataProvider('Plano', array(
            'criteria'=>$criteria,
			'pagination' => array(
