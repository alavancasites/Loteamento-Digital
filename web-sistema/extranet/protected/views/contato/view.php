      ...
      <div class="card">
        ...
        <div class="formSep">
          <dl class="dl-horizontal">
            ...
            <dd><?=Util::formataTexto($model->idempreendimento)?></dd>
          </dl>
        </div>
              ...
              <dl class="dl-horizontal">
                  ...
                  <dd>
                    ...
                    if(Yii::app()->user->obj->group->temPermissaoAction($this->id,'update')){
                        ?>
                        <a class="btn btn-outline-primary" href="<?php echo $this->createUrlRel('update',array('id'=>$model->idcontato));?>"><i class="ion ion-md-create "></i> Editar</a>
                        <?
                    }
                    ?>          
                    <?
