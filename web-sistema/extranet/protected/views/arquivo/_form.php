<div class="form">
	...
	<div class="formSep">
        <dl class="dl-horizontal">
          ...
          <dd>
		  	<?php echo $form->dropDownList($model, 'idarquivo_categoria', GxHtml::listDataEx(ArquivoCategoria::model()->findAllAttributes(null, true)), array('class' => 'input-xxlarge','empty'=>'Selecione...')); ?>
      ...
      <dl class="dl-horizontal">
          ...
          <button type="submit" class="btn">
            ...
            if($this->action->id == 'update' && Yii::app()->user->obj->group->temPermissaoAction($this->id,'delete')){
                ?>
                <a class="btn btn-delete" href="<?php echo $this->createUrlRel('delete',array('id'=>$model->idarquivo));?>" style="margin-left:30px;"><i class="icon-trash"></i> Excluir</a>
                <?
            }
            ?>
        </dd>
